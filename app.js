...
const Auth = {
  ...
  renderOnboardingStep3() {
    ...
    area.innerHTML = `
      ...
      <div class="card" style="max-width:480px;">
        ...
        <div class="row" style="border:1px dashed var(--border); border-radius:10px; padding:14px; cursor:pointer; margin-top:10px;" onclick="Auth.iniciarSincronizacaoExistenteColar()">
  ...
  async fillLanOnboardRow() {
    ...
    try {
      ...
      if (!ok) return;
      row.innerHTML = `
        <div class="row" style="border:1px solid var(--green); border-radius:10px; padding:14px; cursor:pointer; margin-top:10px;" onclick="Auth.iniciarSincronizacaoLan()">
