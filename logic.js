...
const Auth = {
  ...
  async iniciarSincronizacaoExistente() {
    if (!AppSync.supported()) { alert('Seu navegador não suporta esse recurso. Use Google Chrome ou Microsoft Edge para sincronizar.'); return; }
    try {
    ...
    el.innerHTML = `
      ...
      <div class="card" style="margin-bottom:10px;">
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap;">
          ...
          <input type="file" id="fileSyncManual" accept=".kfsync,application/json" style="display:none" onchange="Modals.abrirSyncManual(this.files[0])">
