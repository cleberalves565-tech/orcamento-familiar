    ...
    area.innerHTML = `
      ...
      <div class="card" style="max-width:480px;">
        ...
        <div class="row" style="border:1px dashed var(--border); border-radius:10px; padding:14px; cursor:pointer; margin-top:10px;" onclick="Auth.iniciarSincronizacaoExistenteColar()">
          <div><div class="row-title">Não consegue escolher o arquivo? Cole o código manualmente</div><div class="row-sub">Alternativa quando o seletor de arquivos do celular não deixa selecionar o arquivo sincronizado</div></div>
        </div>
      </div>`;
  },
